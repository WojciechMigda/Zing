 ...
 *******************************************************************************
 * Filename: pdp_security_status.h
 *
 * Description:
 *      PDP Security Status field definitions
 *
 * Authors:
 *          Wojciech Migda (wm)
 *
...
#ifndef PDP_SECURITY_STATUS_H_
#define PDP_SECURITY_STATUS_H_
